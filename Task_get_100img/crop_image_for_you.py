...
class Process_Data():
    ...
    def set_path(self, id):
        ...
        path = f'D:/OneDrive - Industrial University of HoChiMinh City/WORKBASE/Project-rsna-breast-cancer-detection/VinDr-Mammo_Origin_image/VinDr-Mammo_Origin_image/{self.df_main.patient_id[id]}_{id}/{id}.dcm'
    ...
    def save_image(self, img):
        id = self.id
        ls = self.get_info()
        if os.path.exists(f'D:\OneDrive - Industrial University of HoChiMinh City\WORKBASE\Project-rsna-breast-cancer-detection\Meta_Image_origin/{self.head}/') ==False:
            os.makedirs(f'D:\OneDrive - Industrial University of HoChiMinh City\WORKBASE\Project-rsna-breast-cancer-detection\Meta_Image_origin/{self.head}/')
        file_name = f'D:\OneDrive - Industrial University of HoChiMinh City\WORKBASE\Project-rsna-breast-cancer-detection\Meta_Image_origin/{self.head}/ {ls[-1]}_{ls[0]}.png'
        f.write(file_name)
